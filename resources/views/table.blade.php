...
<div class="container">
            ...
            <div class="row mt-2">
            <div class="col-9"></div>
            <div class="col-3"><button class="button btn-info pull-right btn-xs" id="read_data">Load data from database</button></div>
            </div>
            <div class="table-body">
            <table class="table table-stripped table-condensed mt-2">
                    <thead>
                        <tr>
                        <th>#</th>
                        <th>SKU</th>
